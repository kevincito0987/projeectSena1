...
Antes de hacer un commit, asegúrate de formatear el código con **Prettier**. Si no lo tienes instalado, agrégalo con:
...
Para formatear el código manualmente, usa:
...
También puedes agregar un archivo `.prettierrc` para definir las reglas:
...
Si necesitas actualizarlo, simplemente haz `git push` y los cambios se reflejarán automáticamente. 🚀
...
│   ├── main.js      # Funciones y lógica de la app
...
Usamos **Conventional Commits** para mantener un historial ordenado. 📌
...
- `dev` → Desarrollo y nuevas funciones
- `feature/nueva-funcion` → Para trabajar en una funcionalidad específica

📌 **Kanban en GitHub Projects**
 Usamos **GitHub Projects** para organizar tareas y avances. Puedes ver el tablero aquí:
